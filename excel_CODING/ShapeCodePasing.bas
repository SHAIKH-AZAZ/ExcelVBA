...
Set libWB = Workbooks("ShapeLibrary.xlsx")
On Error GoTo 0

If libWB Is Nothing Then
    Set libWB = Workbooks.Open("C:\BBS\ShapeLibrary.xlsx")
End If

Set lib = libWB.Sheets("ShapeLibrary")  ' sheet that contains template shapes
